...
<div class="container mx-auto px-4 py-8">
    <div class="max-w-lg mx-auto bg-white rounded-xl shadow-sm border border-gray-100 p-8">
        ...
        <h1 class="text-2xl font-bold text-gray-800 mb-6">Edit Akun: {{ $petuga->name }}</h1>

        <!-- Form -->
        <form action="{{ route('petugas.update', $petuga->id) }}" method="POST" class="space-y-6">
            @csrf
            ...
            <div>
                ...
                <input type="text" name="name" id="name" value="{{ old('name', $petuga->name) }}" required 
            ...
            <div>
                ...
                <input type="email" name="email" id="email" value="{{ old('email', $petuga->email) }}" required 
            ...
            <div class="flex items-center justify-between pt-4">
                <a href="{{ route('petugas.index') }}" class="text-gray-600 hover:text-gray-800 text-sm font-medium">
                    Batal
                </a>
