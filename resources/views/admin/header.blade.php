    ...
    <div x-show="open" 
        ...
        <div class="px-2 pt-2 pb-3 space-y-1 sm:px-3">
            ...
            <div class="border-t border-purple-500 pt-4 mt-2 pb-2">
                ...
                <a href="{{ route('admin.profil') }}" class="block px-3 py-2 rounded-md text-base font-medium text-purple-100 hover:bg-purple-600 hover:text-white decoration-none flex items-center {{ request()->routeIs('admin.profil') ? 'bg-purple-800 text-white' : '' }}">
