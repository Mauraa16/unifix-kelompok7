    ...
    <div class="container mx-auto px-4 h-full">
        <div class="flex justify-between items-center h-full">
            ...
            <div class="flex items-center space-x-6">
                ...
                <a href="{{ route('home') }}" class="flex items-center gap-2 decoration-none group">
                    ...
                    <div class="flex flex-col">
                        <span class="text-[10px] font-bold text-purple-600 bg-white px-1.5 py-0.5 rounded-full uppercase w-fit mt-0.5">Admin</span>
                    </div>
                </a>
            ...
            <div class="flex items-center gap-4">
                ...
                @php
                    $user = Auth::user();
                    // Gunakan updated_at untuk cache buster agar gambar langsung refresh
    ...
    <div x-show="open" 
        ...
        <div class="px-2 pt-2 pb-3 space-y-1 sm:px-3">
            ...
            <div class="border-t border-purple-500 pt-4 mt-2 pb-2">
                ...
                <a href="{{ route('admin.profil.index') }}" class="block px-3 py-2 rounded-md text-base font-medium text-purple-100 hover:bg-purple-600 hover:text-white decoration-none flex items-center {{ request()->routeIs('admin.profil.index') ? 'bg-purple-800 text-white' : '' }}">
                ...
                <form id="logout-form-mobile-admin" action="{{ route('logout') }}" method="POST" class="hidden">@csrf</form>
            </div>
            @endauth
        </div>
    </div>
