    ...
    <div class="container mx-auto px-4 h-full">
        <div class="flex justify-between items-center h-full">
            ...
            <div class="flex items-center space-x-6">
                {{-- Logo --}}
                <a href="{{ route('home') }}" class="text-2xl font-bold text-white hover:text-gray-200 decoration-none">UNIFIX</a>
            ...
            <div class="flex items-center gap-4">
                ...
                <div class="hidden md:flex items-center gap-4">
                    ...
                    <form id="logout-form-mhs" action="{{ route('logout') }}" method="POST" class="hidden">
                        @csrf
                    </form>
    ...
    <div x-show="open" 
        ...
        <div class="px-2 pt-2 pb-3 space-y-1 sm:px-3">
            ...
            <div class="border-t border-purple-500 pt-4 mt-2 pb-2">
                ...
                {{-- Link Profil Saya (Mobile) --}}
                <a href="{{ route('mahasiswa.profil') }}" 
                   class="block px-3 py-2 rounded-md text-base font-medium text-purple-100 hover:bg-purple-600 hover:text-white decoration-none flex items-center {{ request()->routeIs('mahasiswa.profil') ? 'bg-purple-800 text-white' : '' }}">
                ...
                <form id="logout-form-mobile-mhs" action="{{ route('logout') }}" method="POST" class="hidden">
                    @csrf
                </form>
            </div>
            @endauth
